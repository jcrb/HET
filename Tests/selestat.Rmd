...
Moyennes de référence des indicateurs
-------------------------------------

Sur les graphiques, la valeur moyenne de l'indicateur est marquée par une ligne pointillée VERTE
Les écarts à la moyenne sont exprimées en écart-type:

- un écart-type: ligne pointillée JAUNE
- deux écart-type: ligne pointillée ORANGE
- trois écart-type: ligne pointillée ROUGE
...
Ecarts-types de référence des indicateurs
-------------------------------------
```{r, echo=FALSE, comment=""}
sd.ref[finess, ]
```
...
plot(cal, a, type = "l", main = paste(finess, "- Nombre de RPU par jour"), ylab = "Nb. de patients")
...
plot(cal, a, type = "l", main = paste(finess, "- Patients de 75 ans et plus"), ylab = "Nb. de patients", ylim = c(0,35))
...
plot(cal, a, type = "l", main = paste(finess, "- Durée moyenne de passage par jour"), ylab = "Temps (minutes)", xlab = "", ylim = c(min(a) - 30, max(a) + 30))
...
plot(cal, a, type = "l", main = paste(finess, "- Taux d'hospitalisation par jour"), ylab = "% hospitalisation", xlab = "", ylim = c(0, 0.5))
...
# Graphe
plot(cal, a, type = "l", main = paste(finess, "- Charge de soins"), ylab = "Nb. de patients présents à 15 h", ylim = c(0, max(a) + 10))
